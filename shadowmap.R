...
shadows=shadowmap(DEM=sierra, dx=RESOLUTION, dlight=c(0, 40, 5))
writePNG(shadows, "shadowsEAST.png")

shadows=shadowmap(DEM=sierra, dx=RESOLUTION, dlight=c(0, -40, 5))
writePNG(shadows, "shadowsWEST.png")

shadows=shadowmap(DEM=sierra, dx=RESOLUTION, dlight=c(40, 0, 5))
...
shadows=shadowmap(DEM=sierra, dx=RESOLUTION, dlight=c(0, 30, 5))
...
shadows=shadowmap(DEM=sierra_rotated, dx=RESOLUTION, dlight=c(0, 40, 5))
